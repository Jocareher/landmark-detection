...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=float,
        default=defaults.pca_mahalanobis_limit,
        help="Maximum unpenalized squared Mahalanobis distance per PCA component (D_M^2/K).",
    )
    parser.add_argument(
        "--pca-variance-floor",
        type=float,
        default=defaults.pca_variance_floor,
        help="Eigenvalue floor relative to the largest retained PCA variance, in (0, 1].",
    )
    parser.add_argument(
        "--seed",
        type=int,
